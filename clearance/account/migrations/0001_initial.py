# Generated by Django 4.2.4 on 2023-08-15 01:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=100, null=True)),
                ('departments', models.ManyToManyField(to='account.department')),
            ],
        ),
        migrations.CreateModel(
            name='StudentUser',
            fields=[
                ...
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='student_department', to='account.department')),
                ('faculty', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='student_faculty', to='account.faculty')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(related_name='all_students', to='account.studentuser')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(related_name='gen_students', to='account.studentuser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='screen_department', to='account.department')),
                ('faculty', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='screen_department', to='account.faculty')),
                ...
                ('students', models.ManyToManyField(related_name='screeners', to='account.studentuser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('faculty', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sao_faculty', to='account.faculty')),
                ('sao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sao_user', to=settings.AUTH_USER_MODEL)),
                ('students', models.ManyToManyField(related_name='faculty_students', to='account.studentuser')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dao_department', to='account.department')),
                ('students', models.ManyToManyField(related_name='sdept_students', to='account.studentuser')),
            ],
            options={
